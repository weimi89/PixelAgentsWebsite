...
**每個代理的伺服器狀態**：`id, process, projectDir, jsonlFile, fileOffset, lineBuffer, activeToolIds, activeToolStatuses, activeToolNames, activeSubagentToolIds, activeSubagentToolNames, isWaiting, hadToolsInTurn, permissionSent, model, tmuxSessionName, isDetached, transcriptLog`。
